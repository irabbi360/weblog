        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm bg-dark rounded-3 h-100">
                ...
                <a href="{{ route('singlePost', $post->id) }}">
                    <img class="card-img-top"
                        data-src="{{ $post->thumbnail ? 'storage/uploads/posts/' . $post->thumbnail : asset('images/placeholder-post.png') }}"
                        alt="Thumbnail" style="height: 225px; width: 100%; display: block;"
                        src="{{ $post->thumbnail ? 'storage/uploads/posts/' . $post->thumbnail : asset('images/placeholder-post.png') }}"
                ...
                <div class="card-body">
                    ...
                    <p class="text-gray-400">By <a href="#">{{ optional($post->user)->name }}</a>
