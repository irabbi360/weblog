                ...
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm bg-dark rounded-3 h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-gray-400">By <a href="#">Anonymous</a> <span>2022-02-15</span> <span class="d-inline float-end">3</span> </p>
                            <p class="text-gray-400">Quibusdam aut corrupti non quae sed dignissimos.</p>
                        </div>
